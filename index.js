...
client.on("messageCreate", function(message) {
    ...
    if (command === "src") {
        ...
        axios({
                url: "https://br.video.search.yahoo.com/search/video;_ylt=A2KLfRhB7upgluUATjPz6Qt.;_ylu=Y29sbwNiZjEEcG9zAzEEdnRpZAMEc2VjA3BpdnM-?p=" +
                    ...
                    axios({
                        ...
                        .then((result) => {
                            ...
                            const videoEmbed = new MessageEmbed()
                                ...
                                .setAuthor({
                                    name: "Youtube",
                                    iconURL: "https://img2.gratispng.com/20180330/iyw/kisspng-youtube-red-logo-computer-icons-youtube-5abe39fec046a9.7547336915224161267876.jpg",
                                ...
                                .addField(contentTitle[0].textContent, watchInYt[0].href, true);
    ...
    //menu de comandos
        ...
        .setColor("#B35A33")
            ...
            .addFields({
                name: "google",
                value: "Api da serp que retorna os resultados de qualquer pesquisa no google. Apenas 100 pesquisas por mês são permitidas",
            }, {
                name: "src",
                value: "O bot retorna o primeiro resultado da sua pesquisa de acordo com o search do Yahoo.",
            }, {
                name: "watch",
                value: "O bot retorna o primeiro resultado da sua pesquisa no Yahoo Videos, que geralmente é um vídeo do YouTube, por isso a mensagem personalizada",
            })
            .setTimestamp();
