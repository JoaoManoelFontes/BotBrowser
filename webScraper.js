                ...
                .then((result) => {
                    ...
                    if (res[0] === undefined || res[0] === null || res[0] === "") {
                        const errorEmbed = new MessageEmbed()
                            ...
                            .addFields({
                                name: "erro!",
                                value: "não foi possível encontrar resultados para essa pesquisa",
                            });
            ...
            search.json(params.search, (dataSearch) => {
                search.json(params.image, (dataImg) => {
                    ...
                    const query = new MessageEmbed()
                        ...
                        .setAuthor({
                            name: "Google",
                            iconURL: "https://w7.pngwing.com/pngs/249/19/png-transparent-google-logo-g-suite-google-guava-google-plus-company-text-logo-thumbnail.png",
